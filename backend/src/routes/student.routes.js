...
studentRoutes.put('/add-discount/:id', autenticateToken, authorizeRoles('admin'), student.addDiscount);
studentRoutes.put('/delete-discount/:id', autenticateToken, authorizeRoles('admin'), student.deleteDiscount);
